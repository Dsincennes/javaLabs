...
public class BinaryLinearSearch {
	...
	/**
	 * Method is a using iterative binary as a way of searching for a value
	 *
	...
	public int iterativeBinarySearch(int[] array, int value) { // Method searches for a value with binary method iteratively
		...
		while (start < end) {
			remainingElements(array, start, end);
	...
	/**
	 * Method searched for a value recursively using binary
	 *
	 * @param array 30 random numbers
	...
	/**
	 * Method prints remaining elements in array after it has been split in the
	 * binary searches
	 *
	 * @param leftover array of remaining elemnts
	 * @param start    first index
	 * @param end      last index
	 */
	public void remainingElements(int[] leftover, int start, int end) { // prints remaining values in array when it is
																		// split in binary searching
//        System.out.print("\t");
		for (int i = start; i < end; i++) { // prints left values from start to new end point of array
	...
	/**
	 * Method searched for a value iteratively and linear
	 *
	 * @param array 30 random numbers
	 * @param value value to be searched
	...
	/**
	 * Method does a search using recursive linear
	 *
	 * @param array 30 random numbers
	 * @param start first index
	 * @param end   last index
