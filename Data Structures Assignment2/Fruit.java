...
public class Fruit extends FoodItem { // class is for Fruit object adding
	...
	/**
	 * Overwritten addItem method, calls super of addItem class, then adds onto it with orchard supplier
	 */
	@Override
	public boolean addItem(Scanner scan, boolean fromFile) { // adds info to the fruit item
		if(fromFile){
	 ...
	 */
	@Override
	public String toString() { // Overwritten to string for array printing.
		return super.toString() + " Orchard Supplier: " + orchardName;
	}

	/**
	 * This method formats the way a list is written to a file. orchard name is added to the end of the fruit item
	 *
