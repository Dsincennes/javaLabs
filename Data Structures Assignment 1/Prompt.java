...
public class Prompt { // class holds utility method for input validation
	...
	// utility method, passed a input type, and message, checks for correct input, and returns, else catches the exception and prints result
	/**
	 * This method is a helper method, that takes in a generic, and returns the type if true,
	 * otherwise catches the runTimeException and prints invalid entry
	 * 
